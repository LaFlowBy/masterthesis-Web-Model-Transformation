...
\section{Stakeholders and User Needs}
  ...
  \begin{itemize}
  \textbf{Students}: Students who want to learn about \ac{mde} and transformation rules want a very simple and intuitive entry into the topic. Trying out transformations in the browser is a good start, without having to install a lot of software. For students, the core functionality is sufficient, as they only want to try out transformation rules and learn how they work.
