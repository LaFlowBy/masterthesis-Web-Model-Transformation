...
\begin{itemize}
    ...
    \begin{itemize}
        \item \textbf{Action Type Editor}: In this window, the action types of nodes can be modified. It can be opened by double-clicking on the action type part of a node or an edge. It allows to change the action type of the node between \textit{Preserve}, \textit{Create}, \textit{Delete}, and \textit{Forbid}.
