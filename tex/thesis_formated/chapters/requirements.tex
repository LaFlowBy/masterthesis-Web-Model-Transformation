...
\section{Stakeholders and User Needs}
  ...
  The different Stakeholders show, that the more features the application provides, the more users can be reached. With more features and use cases the application can cover, it provides more value for enterprise users, that work for production systems.
