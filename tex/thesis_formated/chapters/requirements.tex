...
\begin{requirement}
    ...
    The application should be user-friendly and intuitive to use. For that, the application should follow the design principles of \ac{glsp} and Eclipse Theia. That includes the use of views of theia, like the exploerer and the predefined \ac{ui} contorls of \ac{glsp}, like the tool palette or the context menu.
\end{requirement}
